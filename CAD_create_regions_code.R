...
gene_regions <- list(
  ...
  B4GALNT2= c(chr= 17, start= 47209822, end= 47254202),
...
custom_loci <- list(
  ...
  B4GALNT2 = c(chr=17, pos= 47241642)
)
...
output_file <- file.path(output_data_rootname, paste0(phenoname, "_for_coloc_final.txt"))
