...
ggplot(GO_plot, aes(x = 1, y = pval)) +
  ...
  geom_text(aes(label = Description), hjust = -0.1, size = 3.2) +
  labs(
    x = NULL,
    y = expression(paste(italic("p.adjust (log scale)"))),
    title = "Trans-pQTL genes, enrichment"
  ) +
  theme_minimal() +
  theme(
