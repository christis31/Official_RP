...
librarian::shelf(tidyverse, purrr, BiocManager, AnnotationDbi, 
                 qvalue, GO.db, org.Hs.eg.db, reshape2, UniProt.ws, biomaRt, GenomicRanges, ggrepel, ggdark, ggplot2, clusterProfiler, stringr, scales, KSEAapp)
```
...
ggplot(GO_plot, aes(x = Count, y = Description, fill = p.adjust)) +
 geom_col() +
 scale_fill_gradient(
 low = "firebrick",
 high = "steelblue",
