...
GO_result %>% filter(p.adjust < 0.05) %>% slice(1:20) %>%
 ggplot(
  aes(GeneRatio, forcats::fct_reorder(Description, FoldEnrichment))) + 
  ...
  ylab(NULL) + 
  ggtitle("GO Over-repressentation Enrichment Analysis")
